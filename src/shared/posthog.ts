...
type PostHogExceptionProperties = PostHogProperties
...
function getSharedProperties(source: PostHogSource): PostHogProperties {
  return {
...
function createPostHogClient(
  ...
  let configuredClient: Pick<PostHog, "capture" | "captureException" | "shutdown">
