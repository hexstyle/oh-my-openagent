...
4. Use \`edit\` and \`write\` for file changes. Do not use \`apply_patch\` on GPT models. Do not use cat or echo for file creation/editing. Formatting commands or bulk edits don't need manual patch hunks
