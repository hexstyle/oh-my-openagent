...
describe("ci green loop builtin skills", () => {
  ...
  test("dotnet-playwright treats empty waits and idle hangs as a mandatory diagnosis target", () => {
    ...
    expect(dotnetPlaywrightSkill.template).toContain("perl -e 'alarm shift; exec @ARGV' 5400 dotnet test")
    ...
    expect(dotnetPlaywrightSkill.template).toContain("kill -TERM")
    expect(dotnetPlaywrightSkill.template).toContain("kill -KILL")
