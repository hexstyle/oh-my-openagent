...
export const BackgroundTaskConfigSchema = z.object({
  ...
  /** Maximum number of simultaneously pending/running identical tasks (same parent + agent + description + prompt). Prevents runaway duplicate delegation loops. */
  maxIdenticalTasksPerParent: z.number().int().min(1).optional(),
